...
//  Calculator2
//
//  Created by Whealy, Chris on 19/07/2016.
...
class AxesDrawer {
  private struct Constants { static let HashmarkSize: CGFloat = 6 }
  ...
  // and the lines will still be sharp in that case, but might be a pixel (or more theoretically) off of where they
  // should be
